        ...
        <div className="p-2 md:p-4 lg:p-6">
          <div className="container w-full m-auto pt-8 pb-4">
            ...
            <div className="col-12 md:col-8">
              <div className="text-4xl md:text-6xl font-bold line-height-1 mb-4">
                {translations.policy.title}
              </div>
              <div className="text-2xl line-height-3 font-bold mb-4">
                {translations.policy.subtitle}
              </div>
                    ...
                    {section.subdescription && (
                      <span>
                        ...
                        <a
                          ...
                          className="text-primary-300 nav-link p-0 hover:text-white"
                        >
                          {section.subdescription}
                        </a>
                        {"."}
