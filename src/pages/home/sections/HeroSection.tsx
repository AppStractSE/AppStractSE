      ...
      >
        ...
        <div className="container flex w-full m-auto">
          <div className="col-12 md:col-6 relative z-2">
            ...
            <h1 className="text-6xl font-bold mb-1">{translations.homePage.title}</h1>
            <p className="mt-0 mb-4 line-height-3">{translations.homePage.description}</p>
            <div className="flex gap-4 md:flex-row flex-column justify-content-center md:justify-content-start">
              <div>
                <Button
                  onClick={toggleLanguage}
                  label={translations.homePage.buttons.contact}
                  type="button"
                  style={{ minWidth: 250 }}
              ...
              <div>
                <Button
                  label={translations.homePage.buttons.help}
                  type="button"
                  style={{ minWidth: 250 }}
